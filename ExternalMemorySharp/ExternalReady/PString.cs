...
{
	public class PString : ExternalClass
	{
		#region Offsets
		...
		public PString(ExternalMemorySharp emsInstance, UIntPtr address) : base(emsInstance, address) {}
		...
		/// </summary>
		public PString() : this(ExternalMemorySharp.MainEms, UIntPtr.Zero) {}
